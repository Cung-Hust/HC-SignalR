...
class RdHc:
    ...
    # time between 2 consecutive pings is 30s
    # google disconnect consecutive times max is 6
    async def __hc_check_connect_with_internet(self):
        ping_waiting_time = 10
        google_disconnect_count = 0
        google_disconnect_count_limited = 6
    ...
    async def __hc_check_connect_with_cloud(self):
        ...
        while True:
            ...
            if not self.__globalVariables.PingCloudSuccessFlag:
                print("\033[0;31mCan Not Connect To Cloud")
    ...
    async def program_2(self):
        ...
        task2 = asyncio.create_task(self.__hc_report_online_status_to_cloud())
        tasks = [task0, task1, task2]
        await asyncio.gather(*tasks)
