...
class Signalr(ITransport):
    ...
    def send(self, destination, data_send):
        ...
        try:
            ...
            print("\033[1;31mCannot Send Data To Cloud")
            ...
            if (
                ...
                try:
                    if self.__hub is not None:
                        self.__hub.stop()
                        self.__hub = None
                        print("\033[1;33mClear SignalR Connect")
                    ...
                    print(
                        f"\033[1;31mException While Connecting Signalr to Server: {err}"
                    )
                    eliminate_current_progress()
            await asyncio.sleep(15)

    def reconnect(self):
        print("\033[1;31mSignalr Disconnected")
